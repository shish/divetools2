...
export const MaxOperatingDepth = (state: State) => (
    <Screen
        ...
        notice={<O2CleanWarning fo2={state.mod.fo2} />}
    >
        <h2>
        ...
        <h2>
            Max Operating Depth:{" "}
            {Math.floor((state.settings.max_ppo2 / state.mod.fo2 - 1) * 10)}m
        </h2>
        <p>
            Max Operating Pressure:{" "}
            {Math.floor((state.settings.max_ppo2 / state.mod.fo2) * 10) / 10}bar
        </p>
        <p>
            (Using max pP
